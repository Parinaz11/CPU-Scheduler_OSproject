...
# def fcfs_scheduler(core):
#     print('Hey Im core', core)
...
#     print_thread = threading.Thread(target = print_t)
#     kernal_threads = []
#     for core in range(1, 5):
#         kernel_thread = threading.Thread(target = fcfs_scheduler, args = (core,))
